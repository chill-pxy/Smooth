...
set(SMOOTH_PRECOMPILE_PARAMS_IN_PATH "${CMAKE_CURRENT_SOURCE_DIR}/source/precompile/precompile.json.in")
set(SMOOTH_PRECOMPILE_PARAMS_PATH "${PRECOMPILE_TOOLS_PATH}/precompile.json")
configure_file(${SMOOTH_PRECOMPILE_PARAMS_IN_PATH} ${SMOOTH_PRECOMPILE_PARAMS_PATH})
#

if(CMAKE_HOST_WIN32)
        set(PRECOMPILE_PRE_EXE)
    set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/SmoothParser.exe)
        set(sys_include "*")
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux")
        set(PRECOMPILE_PRE_EXE)
    set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/SmoothParser)
        set(sys_include "/usr/include/c++/9/")
elseif(CMAKE_HOST_APPLE)
    find_program((XCRUN_EXECUTABLE xrun))
...
### BUILDING ====================================================================================
set(PRECOMPILE_TARGET "SmoothPreCompile")
